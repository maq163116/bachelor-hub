            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumbs">
                        ...
                        <span class="last-item">Wishlist</span>
                    </div>
                </div><!-- /.col-md-12 -->
            </div><!-- /.row -->
        </div><!-- /.container -->
                    ...
                    <table id="userListTable" class="table table-bordered table-striped table_th_maroon">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                    <a href="<?php echo base_url('details/'.$value->post_id)?>" class="btn btn-sm bg-green"><i class="fa fa-eye"></i></a>
                                    <a href="<?php echo base_url('site/wishlist_delete/'.$value->id); ?>" class="btn btn-sm btn-danger" onclick = 'return confirm("Are You Sure?")'><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php
                                }
